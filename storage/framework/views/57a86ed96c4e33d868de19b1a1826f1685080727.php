...
<head>
    ...
    <link href="<?php echo e(asset('summernote/summernote-bs4.css')); ?>" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('css/main.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('bootstrap-datepicker/bootstrap-datepicker.css')); ?>">

    <!-- Scripts -->
    <script src="<?php echo e(asset('js/app.js')); ?>" ></script>
    <script src="<?php echo e(asset('summernote/summernote-bs4.js')); ?>" ></script>
    <script src="<?php echo e(asset('bootstrap-datepicker/bootstrap-datepicker.js')); ?>"></script>
    <script src="<?php echo e(asset('bootstrap-datepicker/bootstrap-datepicker.ru.min.js')); ?>" ></script>




    <link rel="stylesheet" href="<?php echo e(asset('bootstrap-select-1.13.1/bootstrap-select.min.css')); ?>">
    <script src="<?php echo e(asset('bootstrap-select-1.13.1/bootstrap-select.min.js')); ?>"></script>
...
<div id="app">
    ...
    <?php
        ...
        $mainMenuData = [
            ...
            [
                'role' => 'user',
                'url' => 'shorturlnew_category',
                'title' => 'Go.gl',
                'svg_class_1' => $mainMenuSVGclass1,
                'svg' => '<svg class="octicon octicon-code __SVG_REPLACE_CLASS__" viewBox="0 0 16 16" width="32" height="28"><path fill-rule="evenodd" d="M1.592 2.712L2.38 7.25h4.87a.75.75 0 110 1.5H2.38l-.788 4.538L13.929 8 1.592 2.712zM.989 8L.064 2.68a1.341 1.341 0 011.85-1.462l13.402 5.744a1.13 1.13 0 010 2.076L1.913 14.782a1.341 1.341 0 01-1.85-1.463L.99 8z"></path></svg>',
            ],
                    ...
                    <div class="leftbar">
                        ...
                        <div class="main-menu">
                            ...
                            <ul class="list-unstyled mainul">
                                ...
                                <?php $__currentLoopData = $mainMenuData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuKey => $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(Auth::user()->isAdmin() || Auth::user()->isUser()): ?>
                                        <li>
                                            <a href="<?php echo e(url($menu['url'])); ?>">
                                                <?=$menu['svg']?><span class="text"><?php echo e($menu['title']); ?></span>
                                            </a>
                                        </li>
                                    <?php elseif(Auth::user()->isUser() && $menu['role'] === Auth::user()::ROLE_USER): ?>
                                        <li>
                                            <a href="<?php echo e(url($menu['url'])); ?>">
                                                <?=$menu['svg']?><span class="text"><?php echo e($menu['title']); ?></span>
                                            </a>
...
</html><?php /**PATH C:\OpenServer3\domains\laravel_events\resources\views/layouts/event.blade.php ENDPATH**/ ?>