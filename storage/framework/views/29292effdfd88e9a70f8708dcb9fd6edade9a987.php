                ...
                <div class="accordion" id="accordionEventoTag">
                    <div class="accordion-item">
                        ...
                        <div id="collapse3" class="accordion-collapse collapse show" aria-labelledby="heading3" data-parent="#accordionEventoTag">
                            <div class="accordion-body">
                                <form action="<?php echo e(route('cabinet.evento.eventotag.store_ajax')); ?>" method="POST" name="addEventoTagForm">
                                    <div class="modal-body">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="heading4" data-parent="#accordionEventoTag">
                            <div class="accordion-body">
                                <form action="<?php echo e(route('cabinet.evento.eventotag.store_ajax')); ?>" method="POST" name="addStandaloneTagForm">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="tag_id" value="0">
                                    <div class="modal-body">
                                        <div class="input-group mb-3">
...
</div><?php /**PATH C:\OpenServer3\domains\laravel_events\resources\views/cabinet/evento/_inner/modals/add_tag.blade.php ENDPATH**/ ?>