                ...
                <div class="accordion" id="accordionEventoCategory">
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-parent="#accordionEventoCategory">
                            <div class="accordion-body">
                                <form action="<?php echo e(route('cabinet.evento.eventocategory.store_ajax')); ?>" method="POST" name="addCategoryForm">
                                    <div class="modal-body">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-parent="#accordionEventoCategory">
                            <div class="accordion-body">
                                <form action="<?php echo e(route('cabinet.evento.category.store_ajax')); ?>" method="POST" name="addStandaloneCategoryForm">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="category_id" value="0">
                                    <div class="modal-body">
...
</div><?php /**PATH C:\OpenServer3\domains\laravel_events\resources\views/cabinet/evento/_inner/modals/add_category.blade.php ENDPATH**/ ?>