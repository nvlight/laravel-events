                ...
                <div class="form-group">
                    <form action="/add-tag/now" method="POST" name="editTagForm" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="d-flex align-self-center spinMessage__wrapper tagEdit__wrapper">
                                <div class="d-flex">
...
</div><?php /**PATH C:\OpenServer3\domains\laravel_events\resources\views/cabinet/evento/_inner/modals/edit_tag.blade.php ENDPATH**/ ?>