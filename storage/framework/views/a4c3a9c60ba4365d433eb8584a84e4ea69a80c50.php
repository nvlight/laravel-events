    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form action="<?php echo e(route('cabinet.evento.eventotagcounting.get_pie_ajax_by_year')); ?>"
...
</div><?php /**PATH C:\OpenServer3\domains\laravel_events\resources\views/cabinet/evento/_inner/modals/diagramms/tagvalues_by_year.blade.php ENDPATH**/ ?>